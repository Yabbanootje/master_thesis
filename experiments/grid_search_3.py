...
if __name__ == '__main__':
    ...
    last_means.to_csv("app/figures/grid_search_3/last_means.csv")

    # Load data
    last_means = pd.read_csv("app/figures/grid_search_3/last_means.csv").set_index(parameters)
    ...
    plt.tight_layout()
    plt.savefig(f"app/figures/grid_search_3/curriculum_heatmap_log_costs_more_colors.png")
    plt.show()
    plt.close()