...
if __name__ == '__main__':
    ...
    seeds = [7596, 3743, 9733, 4678, 175, 3968, 5689, 572, 7337, 5905] # [5905, 7337, 572, 5689, 3968] # [175, 4678, 9733, 3743, 7596] # [int(rand.random() * 10000) for i in range(repetitions)]
    betas = [0.5, 1.0, 1.5]
    kappas = [5, 10, 20]
