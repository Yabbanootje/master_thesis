...
Most of this code is taken from Safety-Gymnasium, but to get our own tasks we have to
slightly change this file to have it work for our purposes and update the source code of
Safety-Gymnasium when running our code.
"""
